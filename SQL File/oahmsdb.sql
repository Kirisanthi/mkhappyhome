...
CREATE TABLE `tblcontact` (
  ...
  `Contact DetailsDate` timestamp NOT NULL DEFAULT current_timestamp(),
...
INSERT INTO `tblcontact` (`ID`, `FirstName`, `LastName`, `Email`, `Phone`, `Message`, `Contact DetailsDate`, `IsRead`) VALUES
