...
<head>
  ...
  <title>MK Happy Home|| Add Senior Details</title>
  <!-- base:css -->
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title" style="color:#2D6D4E">Add Senior Citizen</h4>
                  ...
                  <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary mr-2" name="submit" style="margin-left:80%">Submit</button>
                  </form>
                </div>
              </div>
            </div>
