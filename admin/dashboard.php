...
<head>
    <title>MK Happy Home || Dashboard</title>
    <!-- base:css -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between justify-content-md-center justify-content-xl-between flex-wrap mb-4">
                                        <div>
                                            <?php 
                                            $query1 = mysqli_query($con, "SELECT ID FROM tblservices");
                                            $totservices = mysqli_num_rows($query1);
                                            ?>
                                            <h5 class="mb-0" style="color:#2D6D4E">Total Services</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between justify-content-md-center justify-content-xl-between flex-wrap mb-4">
                                        <div>
                                            <?php 
                                            $query2 = mysqli_query($con, "SELECT ID FROM tblseniorcitizen");
                                            $totsccount = mysqli_num_rows($query2);
                                            ?>
                                            <h5 class="mb-0" style="color:#2D6D4E">Senior Citizen</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between justify-content-md-center justify-content-xl-between flex-wrap mb-4">
                                        <div>
                                            <?php 
                                            $query3 = mysqli_query($con, "SELECT ID FROM tblcontact WHERE IsRead IS NULL");
                                            $totunreadenq = mysqli_num_rows($query3);
                                            ?>
                                            <h5 class="mb-0" style="color:#2D6D4E">Unread Contact Details</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between justify-content-md-center justify-content-xl-between flex-wrap mb-4">
                                        <div>
                                            <?php 
                                            $query4 = mysqli_query($con, "SELECT ID FROM tblcontact WHERE IsRead='1'");
                                            $totreadenq = mysqli_num_rows($query4);
                                            ?>
                                            <h5 class="mb-0" style="color:#2D6D4E">Read Contact Details</h5>
