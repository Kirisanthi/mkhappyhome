...
<head>
  ...
  <title>MK Happy Home|| Read Contact Details</title>
  <!-- base:css -->
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-center">
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item ml-0">
            <h4 class="mb-0">Read Contact Details</h4>
          </li>
        </ul>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <h4 class="card-title" style="padding-left: 20px; padding-top: 20px;" style="color:#2D6D4E" >Read Contact Details</h4>
