...
<div class="banner-section">
	<div class="container">
		...
		<div class="welcome-section">
				<div class="container"  style="border: 3px solid #2D6D4E;">
					<div class="welcom-grids" style="padding-top:2%; padding-bottom:2%">
						<div class="col-md-6 welcom-grid-img" >
						<h3 style="color: #2D6D4E">About Us</h3>
...
<div class="container">
	<h3 style="color: #2D6D4E">Our Main Services</h3>
	<?php
    ...
    <div class="col-md-4" style="margin-top:1%; margin-bottom:1%">
            ...
            <div  style="border: 3px solid #2D6D4E; padding:5px">
              <div >
